...
from core.Errors import PixelColorMismatchError
from PIL import Image
import time

class GameInterface(Subscriber, Publisher):
    
    def __init__(self, input_handler: InputHandler, screenshot_tool: ScreenshotTool):
        super().__init__()
    ...
    def is_zone_scrolldown_up(self):
        return self._screenshot_tool.matches_expected_color(COORDINATES["is_zone_scrollbar_first_position"])
    ...
    def is_fish_max_catch_rate(self) -> bool:
        return self._screenshot_tool.matches_expected_color(COORDINATES["fish_max_catch_rate"])
    ...
    def is_in_persuasion_state(self) -> bool:
        return self._screenshot_tool.matches_expected_color(COORDINATES["is_persuasion_state"])

    def is_dungeon_completed(self) -> bool:
        return self._screenshot_tool.matches_expected_color(COORDINATES["is_dungeon_finished"])
    ...
    def wait_till_ready(self, expected_state_callback: callable, timeout: int = 60, screenshot_cooldown: float = 0.5) -> bool:
