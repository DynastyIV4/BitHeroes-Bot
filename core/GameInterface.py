...
class GameInterface(Subscriber, Publisher):
    ...
    def __init__(self, input_handler: InputHandler, screenshot_tool: ScreenshotTool, window_handler: WindowHandler, logger: Logger):
        super().__init__()
    ...
    def is_home_state(self) -> bool:
        return self._screenshot_tool.matches_expected_color(COORDINATES["is_home_state"], False)
    ...
    def is_game_ready(self) -> bool:
        return self._screenshot_tool.matches_expected_color(COORDINATES["is_window_open_on_home_state"], False) or self.is_home_state()
    ...
    def wait_till_ready(self, 
        ...
        self._logger.print(f"Waiting for state: {expected_state_callback.__name__} ...", True)
        ...
        self._logger.print(f"Reached state: {expected_state_callback.__name__}", True)
        return True
