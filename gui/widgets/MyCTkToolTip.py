from customtkinter import CTkSegmentedButton, ThemeManager, StringVar, CTkFrame, CTkLabel, CTkToplevel
import time
import sys

class MyCTkToolTip(CTkToplevel):
    """
    ...
    def __init__(
        ...
        if isinstance(widget, CTkSegmentedButton):
            ...
            self.transparent_frame = CTkFrame(self, fg_color=self.transparent_color, corner_radius=0, border_width=0)
            ...
            self.message_label = CTkLabel(self.frame, 
