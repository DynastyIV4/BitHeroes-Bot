...
Author: Akash Bora
Some adjustements were made because the widget have bugs and lacks flexibilty
"""

import customtkinter
import ast

class MyCTkListbox(customtkinter.CTkScrollableFrame):
    def __init__(
        self,
        master: any,
        height: int = 100,
    ...
    def multiple_select(self, index: list):
        for i in index:
            self.select(i)
    ...
    def insert(self, index, option, update=True, custom_text_color = None, **args):
        ...
        self.buttons[index] = customtkinter.CTkButton(
            ...
            anchor=self.justify,
            text_color=custom_text_color if custom_text_color else self.text_color,
            font=self.font,
